...
public class AllbaBoardServiceImpl implements AllbaBoardService {
	...
	public List<Map<String, String>> list(final String sitename, final String category, final String value,
			final String c, final int start) {
		// TODO Auto-generated method stub

		return dao.list(sitename, category, value, c, start);
	}
	...
	/*
	 * @Override public void write(final String sitename, final AllbaBoardDTO dto) {
	 * // TODO Auto-generated method stub dao.write(sitename, dto); }
	 */
	// 게시물 조회 /수정 get
	@Override
	...
	public List<Map<String, String>> search(String sitename, String keyword, int stratValue) {
		// TODO Auto-generated method stub
		return dao.search(sitename, keyword, stratValue);
	}
	...
	public int getTotalCount(String sitename, final String category, final String value) {
		// TODO Auto-generated method stub
		return dao.getTotalCount(sitename, category, value);
	}
	...
	public int getSearchCount(String sitename, String keyword) {
		// TODO Auto-generated method stub
		return dao.getSearchCount(sitename, keyword);
	}
