            ...
            <div class="p-5">
                <div class="text-center">
                   ...
                   <div class="row form-group mb-3">
                        		...
                        		<a href="/allba/${sitename}/event/modify?eventid=${dto.eventid}">
                        		<button class="btn btn-primary btn-user ">수정</button></a>
                        		<a href="/allba/${sitename}/event/delete?eventid=${dto.eventid}">
                        		<button class="btn btn-secondary btn-user ">삭제</button></a>
                        		</c:if>
                        		</div>
