...
function change(){
	if(document.getElementById("mark").style.display ==''){
		...
		document.getElementById('name').innerHTML="리스트형식";
		$('#mark').children().hide();
		$('#table').children().show();
	}else{
		document.getElementById("mark").style.display ='';
		document.getElementById('name').innerHTML="카드형식";
		$('#mark').children().show();
		$('#table').children().hide();
	}
}
...
<div class=" bg-light" style="min-height: 80%;">
    <div class="container" style="max-width: 1920px;">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 font-weight-bold">${sitename} <font class="font-italic font-weight-light text-primary text-sm text-blue-"></font></h1>
           <!--  -
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <c:forEach items="${list}" var="list">
                            	 <a target="_blank" rel="nofollow" href="${list.link}">
        ...
        <div class="col-lg-12 mb-4">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800 font-weight-bold">어떤 옷이 등록되어있을까요?<font class="font-italic font-weight-light text-primary text-sm text-blue-"></font></h1>
                <div >
            ...
            <div id ="table" class="row">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">어떤 옷이 등록되어있는지 확인해보세요!!.</h6>
                    </div>
                    <div class="card-body">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-2 py-2">
            <h1 class="h3 mb-1 text-gray-800 font-weight-bold"><br/>내가  살 옷은 어떤게 있을까요?<font class="font-italic font-weight-light text-primary text-sm text-blue-"></font></h1>
        </div>
        ...
        <div class="col-lg-12 mb-4">
            <div class="shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <a target="_blank" rel="nofollow" href="#">카테고리별로 게시물을 확인해보세요!</a>
                </div>
            </div>
        </div>
    </div>
