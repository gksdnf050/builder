    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    <!-- This is Topbar-->
                    <%@ include file="/WEB-INF/views/people/_mixins/topbar.jsp" %>

                    <div class="container-fluid">
                        <h1 class="h3 mb-0 text-gray-800 font-weight-bold">아르바이트 모집공고 작성하기 <font class="font-italic font-weight-light text-primary text-sm text-blue-">BETA</font></h1>
                    </div>
                </div>
                <!-- End of Main Content -->

                <!-- Footer -->
                <%@ include file="/WEB-INF/views/people/_mixins/footer.jsp" %>
            </div>
