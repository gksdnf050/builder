...
<c:forEach items="${dtos}" var="dtos">
 ${dtos.location} <a href="/people/${sitename}/view?boardid=${dtos.getBoardid()}"> ${dtos.getTitle()} </a> ${dtos.money} ${dtos.regdate}
<a href="/people/${sitename}/bookmark/delete?boardid=${dtos.getBoardid()}"> 삭제 </a>
</c:forEach>
</body>
</html>